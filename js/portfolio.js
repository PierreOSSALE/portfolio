fetch("./json/portfolio-index.json")
    ...
    limitedProjects.forEach((project) => {
      ...
      portfolioCard.innerHTML = `
        ...
        project.title
              ...
              <ul class="my-portfolio data-i18n="portfolio2.project${
                project.id
              }.featureOption">
                      <li><i class="fa-solid fa-circle-check"></i><p></p></li>
                 
              </ul>
             
              <h4 data-i18n="role">Role in the Project</h4>
              <p>${project.role}</p>
              <h4 data-i18n="portfolio2.projectLink">Project Links</h4>
              <p>
                <a href="${
                  project.projectLinks[0].url
                }" target="_blank" rel="noopener" class="element" data-i18n="portfolio2.project${
        project.id
      }.projectLinks">
                  ${project.projectLinks[0].text}
                </a>
              </p>
              <h4 data-i18n="portfolio2.demoLink">Demonstrations</h4>
              <p>
                <a href="${
